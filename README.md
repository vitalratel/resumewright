...
✅ **ATS-Compatible Output** - PDFs optimized for Applicant Tracking Systems
✅ **Custom Font Support** - Embed custom fonts in your PDFs
...
✅ **Local-Only Storage** - Settings and history stored in browser (no cloud sync)
...
| `pnpm ci` | Run full CI validation locally (typecheck → lint → build → test) |
...
This runs: **typecheck → lint → build → test → bundle validation**
...
resumewright/
├── packages/
│   ├── extension/          # TypeScript browser extension (WXT-based)
│   │   ├── src/
│   │   │   ├── background/ # Service worker (Manifest V3)
│   │   │   ├── content/    # TSX extractor (optional in v1.7)
...
│       ├── style-resolver/ # Tailwind CSS and style resolution
│       ├── layout-engine/  # Box layout algorithm (Taffy-based)
│       ├── layout-types/   # Layout type definitions
│       ├── pdf-generator/  # PDF generation with lopdf
│       ├── font-toolkit/   # Font embedding and WOFF2 decompression
│       ├── wasm-bridge/    # WASM bindings
│       ├── pdf-test-utils/ # Testing utilities
│       ├── pdf-to-png/     # Visual regression support
│       ├── pdf-fixture-generator/ # Test fixture generation
│       └── regex-utils/    # WASM-compatible regex patterns
├── docs/
│   ├── architecture/       # Architecture documentation (20+ files)
│   ├── stories/            # User stories (Epic 0-4)
...
**Completed:**
- ✅ PDF generation engine with multi-page support
- ✅ Google Fonts embedding with subsetting
- ✅ Custom font support (TTF, OTF)
- ✅ WASM bundle optimization (1.43 MB compressed)
- ✅ Progress indicators

**In Progress:**
- 🔄 Error handling improvements
- 🔄 Auto-naming and download management
