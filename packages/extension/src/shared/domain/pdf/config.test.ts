// ABOUTME: Tests for PDF config conversion from TypeScript to WASM format.
// ABOUTME: Verifies margin conversion, page size mapping, and validation error propagation.
