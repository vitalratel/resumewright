...
export const Button = (
    { ref, variant = 'primary', fullWidth = true, children, className = '', loading = false, success = false, icon: Icon, disabled, onClick, ...props }: ButtonProps & { ref?: React.RefObject<HTMLButtonElement | null> },
  ) => {
    ...
    const variantClasses = React.useMemo(() => ({
      primary:
      `${tokens.colors.primary.bg} ${tokens.colors.primary.hover} hover:scale-[1.02] hover:shadow-lg active:bg-blue-800 dark:active:bg-blue-300 active:scale-[0.98] text-white focus:ring-blue-500 dark:focus:ring-blue-400 ${tokens.effects.disabledState} disabled:hover:scale-100 disabled:shadow-none`,
      secondary:
      ...
      tertiary:
          `${tokens.colors.neutral.bg} ${tokens.buttons.variants.tertiary} hover:scale-[1.01] hover:shadow-sm active:scale-[0.99] ${tokens.colors.neutral.textMuted} focus:ring-blue-500 dark:focus:ring-blue-400 ${tokens.effects.disabledState} disabled:hover:scale-100 disabled:shadow-none`,
      danger:
        `${tokens.buttons.variants.danger} hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] text-white focus:ring-red-500 dark:focus:ring-red-400 ${tokens.effects.disabledState} disabled:hover:scale-100 disabled:shadow-none`,
      ghost:
        `${tokens.buttons.variants.ghost} hover:scale-[1.01] active:scale-[0.99] ${tokens.colors.neutral.textMuted} focus:ring-blue-500 dark:focus:ring-blue-400 focus:ring-[3px] focus:bg-gray-50 dark:focus:bg-gray-800 ${tokens.effects.disabledState} disabled:hover:scale-100`,
      link:
        `min-h-11 flex items-center ${tokens.buttons.variants.link} active:scale-[0.98] ${tokens.colors.info.text} focus:ring-blue-500 dark:focus:ring-blue-400 disabled:opacity-50 disabled:no-underline disabled:cursor-not-allowed disabled:hover:scale-100`,
    }), []);
