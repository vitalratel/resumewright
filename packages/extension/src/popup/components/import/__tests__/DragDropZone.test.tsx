...
describe('DragDropZone', () => {
  ...
  describe('File Selection via Browse Button', () => {
    it('browse button opens file picker', () => {
      render(() => <DragDropZone onFileDrop={mockOnFileDrop} isValidating={false} />);
    ...
    it('calls onFileDrop when file is selected', () => {
      render(() => <DragDropZone onFileDrop={mockOnFileDrop} isValidating={false} />);

      const fileInput = screen.getByLabelText('File input for CV import') as HTMLInputElement;

      // Create mock file and set on input
