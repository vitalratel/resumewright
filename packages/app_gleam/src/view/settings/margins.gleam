...
pub fn view(settings: Settings) -> Element(Msg) {
  ...
  html.fieldset([attribute.class("space-y-3")], [
    ...
    html.div([attribute.class("flex gap-6 items-center")], [
      html.div([attribute.class("flex-1 space-y-3 min-w-0")], [
...
fn preview(margin: Margin) -> Element(Msg) {
  html.div([attribute.class("flex flex-col items-center gap-1 shrink-0")], [
    html.p([attribute.class("text-xs text-muted-foreground")], [
      html.text("Preview"),
    ]),
    html.div(
      ...
      [
        ...
        html.span(
          [
            attribute.class(
              "margin-label-top absolute text-[9px] text-muted-foreground",
            ),
          ],
        ...
        html.span(
          [
            attribute.class(
              "margin-label-bottom absolute text-[9px] text-muted-foreground",
            ),
          ],
        ...
        html.span(
          [
            attribute.class(
              "margin-label-left absolute text-[9px] text-muted-foreground",
            ),
          ],
        ...
        html.span(
          [
            attribute.class(
              "margin-label-right absolute text-[9px] text-muted-foreground",
            ),
          ],
